                ...
                <div className="grid md:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="bg-white dark:bg-darkCard rounded-lg shadow-md p-8 border border-gray-200 dark:border-gray-800">
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            <div className="w-full md:w-56 mx-auto space-y-6">
                                {/* Name */}
                                <div>
                                ...
                                <button
                                    type="submit"
                                    className="w-full block px-4 bg-blue-900 text-white font-semibold py-3 rounded-md hover:bg-blue-800 transition"
                                >
                                    Send Message
                                </button>
                            </div>
                    ...
                    <div className="bg-white dark:bg-darkCard rounded-lg shadow-md p-8 border border-gray-200 dark:border-gray-800">
                        ...
                        <div className="w-full md:w-56 mx-auto space-y-6">
                            {/* Email */}
                            <div className="border-2 border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3">
